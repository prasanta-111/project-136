$(document).ready(function(){
   ...
   // check if submit button under 'camers' is clicked and get the review accordingly
   $('#m_button').click(function(){
   ...
   // check if submit button under 'head phones' is clicked and get the review accordingly
   $('#m_button').click(function(){
   ...
   // check if submit button under 'games' is clicked  and get the review accordingly
   $('#m_button').click(function(){
